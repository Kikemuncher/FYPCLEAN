  ...
  return (
    <div className="min-h-screen bg-black flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h1 className="text-2xl font-bold text-center mb-6">Log in to Goysly</h1>
        <p className="mt-2 text-center text-sm text-gray-400">
          Or{' '}
          <Link href="/auth/signup" className="font-medium text-tiktok-pink hover:text-pink-400">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link href="/auth/reset-password" className="font-medium text-tiktok-pink hover:text-pink-400">
